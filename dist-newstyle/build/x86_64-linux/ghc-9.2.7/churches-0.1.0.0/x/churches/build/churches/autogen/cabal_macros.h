...
/* package churches-0.1.0.0 */
#ifndef VERSION_churches
#define VERSION_churches "0.1.0.0"
#endif /* VERSION_churches */
#ifndef MIN_VERSION_churches
#define MIN_VERSION_churches(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_churches */
...
#define CURRENT_COMPONENT_ID "churches-0.1.0.0-inplace-churches"
